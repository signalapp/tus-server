/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: acbe49966a69e5e2f190930d4b14d730)
// Runtime types generated with workerd@1.20260317.1 2023-05-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AttachmentUploadHandler" | "BackupUploadHandler";
	}
	interface ProductionEnv {
		ATTACHMENT_BUCKET: R2Bucket;
		BACKUP_BUCKET: R2Bucket;
		SHARED_AUTH_SECRET: string;
		ATTACHMENT_UPLOAD_HANDLER: DurableObjectNamespace<import("./src/index").AttachmentUploadHandler>;
		BACKUP_UPLOAD_HANDLER: DurableObjectNamespace<import("./src/index").BackupUploadHandler>;
	}
